                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="contacts__map">
                            <?php 
                                echo do_shortcode('[yamap center="55.7473,37.6247" height="100%" controls="" zoom="14" type="yandex#map" scrollzoom="0" mobiledrag="0"][/yamap]');
                            ?>
                        </div>
                    </div>
                </div>
                <div class="row">
                            ...
                            <div class="contacts__phones">
                                <div class="contacts__phoneblock">
                                    ...
                                    <div class="contacts__phonewrap">
                                        ...
                                        <a href="tel:+797867834347"><?php the_field(number_1); ?></a>
                                    </div>
                                </div>
                                <div class="contacts__phoneblock">
                                    Телефон №2
                                    <div class="contacts__phonewrap">
                                        ...
                                        <a href="tel:+797867834358"><?php the_field(number_2); ?></a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div action="#" class="contacts__feed">
                            <?php
                            echo do_shortcode('[contact-form-7 id="138" title="Форма отзывов"]');
                            ?>
                        ...
                        ?>
                             <li class="glide__slide">
                                        <div class="feedslider__title">
                                           <p> <?php the_field( 'feed_title' ); ?></p>
                                        </div>
                                        <div class="feedslider__text">
                                            <p><?php the_field( 'feed_text' ); ?></p> 
                                        </div>
                                    </li>
