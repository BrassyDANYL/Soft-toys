            ...
            <div class="reply__body">
                ...
                <div action="#">
                    <div class="reply__wrapper">
                      <?php
                      echo do_shortcode('[contact-form-7 id="139" title="Попап"]');
                      ?>
                    </div>
                    <div class="reply__wrapper">
                    ...
                    <div class="col-md-8 offset-md-0 col-lg-6 col-xl-5 offset-xl-1">
                        <div class="footer__contacts">
                            ...
                            <div class="footer__contacts-item">
                                ...
                                <a href="<?php the_field( 'maps' ); ?>">ул. Василисы Кожиной, 1<br>
                                    Москва, Россия, 121096</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        ...
                        <?php
                            wp_footer();
                        ?>
                        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBMoXSKt4K2OvWJuSA_1XYj6ZOSXm1883c"></script>
